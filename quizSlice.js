  ...
  reducers: {
    ...
    previousQuestion: (state) =>{
      if(state.currentQuestionIndex > 0){
        ...
        //Remove the answer for the current questions if going back
        state.answers = state.answers.filter((answer)=> answer.questionId !==state.questions
        [state.currentQuestionIndex].id);
