  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
        <div className="mb-9">
          <div
            className="inline-flex items-center justify-center w-24 h-24
                    bg-gradient-to-br from-blue-100 to-purple-100 rounded-full mb-8"
          >
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Test your knowledge of React, and Web development. Answer multiple
            choice questions and see how well you know the fundamentals!
          </p>
        </div>
        {/* Cards */}
          ...
          <div className="text-left bg-gray-50 p-6 rounded-xl max-w-2xl mx-auto">
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start">
                <span
                  className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600
              ...
              <li className="flex items-start">
                ...
                <span>You can navigate to previous question</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <button
          className="inline-flex items-center space-x-3 py-4 px-8 bg-gradient-to-r
