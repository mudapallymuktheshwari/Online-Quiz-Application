    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        <div className="mb-8">
          ...
          <div className="grid gap-4">
            ...
            {currentQuestion.options.map((option, index) => {
              ...
              let buttonClass = `w-full p-4 text-left rounded-xl border-1 border-gray-300
              transition-all-200 duration-200`;
              ...
              if (showExplanation) {
                ...
                buttonClass += `border-gray-200 bg-white text-gray-700 hover:border-blue-300
        ...
        <div className="flex justify-between items-center">
          <button
            className="flex items-ceter space-x-2 px-6 py-3 bg-gray-100 text-gray-700
